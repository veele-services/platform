...
export const platformThemeSettingsTable = pgTable(
  "platform_theme_settings",
  {
    ...
    splashStoragePath: text("splash_storage_path"),
    ...
    sidebarBackgroundColor: varchar("sidebar_background_color", { length: 20 }).notNull().default("#081D3A"),
    sidebarTextColor: varchar("sidebar_text_color", { length: 20 }).notNull().default("#FFFFFF"),
    sidebarAccentColor: varchar("sidebar_accent_color", { length: 20 }).notNull().default("#00B7B3"),
...
export const tenantThemeSettingsTable = pgTable(
  "tenant_theme_settings",
  {
    ...
    sidebarAccentColor: varchar("sidebar_accent_color", { length: 20 }),
