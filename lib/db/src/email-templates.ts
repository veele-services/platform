...
const EMAIL_TEMPLATES: Record<EmailTemplateKey, EmailTemplateDefinition> = {
  account_invite: {
    ...
    category: "account",
    subject: "Toegang tot {{portalName}}",
    preheader: "Er staat een account voor u klaar in {{portalName}}.",
    headline: "Uw portaaltoegang",
    intro: [
      "Beste {{recipientName}},",
      "Er is een account voor u aangemaakt in {{brandName}}.",
      "Log in met onderstaand tijdelijk wachtwoord. Na de eerste login kiest u direct een eigen wachtwoord.",
    ],
    detailRows: [
  ...
  password_reset: {
    ...
    preheader: "Gebruik de herstelcode om een nieuw wachtwoord te kiezen.",
    headline: "Wachtwoord opnieuw instellen",
    intro: [
      "Beste {{recipientName}},",
      "Er is een wachtwoord-reset aangevraagd voor uw account in {{portalName}}.",
      "Open de resetpagina en vul onderstaande code in. Daarna kiest u direct een nieuw wachtwoord.",
    ],
    detailRows: [{ label: "Herstelcode", value: "{{code}}", monospace: true }],
    cta: { label: "Resetpagina openen", href: "{{resetUrl}}" },
    footerNote: "Deze code is 30 minuten geldig. Heeft u dit niet aangevraagd, dan kunt u deze e-mail negeren.",
  ...
  report_submitted: {
    ...
    intro: [
      "{{reporterName}} heeft een nieuw rapport ingediend voor opdracht {{assignmentTitle}}.",
      "Het rapport staat klaar voor beoordeling in de backoffice.",
    ],
    detailRows: [
  ...
  leave_request_submitted: {
    ...
    intro: [
      ...
      "Controleer de aanvraag en verwerk de planning wanneer de aanvraag is beoordeeld.",
    ],
    detailRows: [
    ...
    cta: { label: "Verlofaanvragen bekijken", href: "{{leaveUrl}}" },
  ...
  report_approved: {
    ...
    intro: [
      "Beste {{firstName}},",
      "Goed nieuws: uw ingediende rapport voor opdracht {{assignmentTitle}} is goedgekeurd.",
    ],
  ...
  report_rejected: {
    key: "report_rejected",
    name: "Rapport afgekeurd",
    category: "reports",
    subject: "Uw rapport voor \"{{assignmentTitle}}\" is afgekeurd",
    preheader: "Uw ingediende rapport is afgekeurd.",
    headline: "Rapport afgekeurd",
    intro: [
      "Beste {{firstName}},",
      "Uw ingediende rapport voor opdracht {{assignmentTitle}} is helaas afgekeurd.",
  ...
  quote_expired: {
    ...
    category: "quotes",
    subject: "Uw offerte {{quoteNumber}} is verlopen",
    preheader: "Offerte {{quoteNumber}} is verlopen.",
    headline: "Offerte verlopen",
    intro: [
      "Beste {{customerName}},",
      "Offerte {{quoteNumber}} is verlopen. Neem contact met ons op als u nog gebruik wilt maken van onze diensten.",
    ],
    detailRows: [
  ...
  quote_decision_received: {
    ...
    intro: [
      "Klant {{customerName}} heeft offerte {{quoteNumber}} {{decision}}.",
      "Controleer de offerte in de backoffice voor de vervolgstappen.",
    ],
    detailRows: [
    ...
    cta: { label: "Offertes bekijken in backoffice", href: "{{quotesUrl}}" },
  ...
  quote_available: {
    ...
    category: "quotes",
    subject: "Uw offerte {{quoteNumber}}",
    preheader: "Er staat een offerte voor u klaar.",
    headline: "Offerte {{quoteNumber}}",
    intro: [
      "Beste {{customerName}},",
      "Wij sturen u hierbij onze offerte toe. U kunt de offerte bekijken en direct accorderen via de knop hieronder.",
    ],
    detailRows: [
      { label: "Offertenummer", value: "{{quoteNumber}}" },
      { label: "Bedrag", value: "{{amount}}" },
    ...
    cta: { label: "Offerte bekijken en accorderen", href: "{{quoteUrl}}" },
  ...
  invoice_available: {
    ...
    preheader: "Uw factuur {{invoiceNumber}} is beschikbaar.",
    headline: "Uw factuur",
    intro: [
      "Beste {{customerName}},",
      "Bijgaand ontvangt u factuur {{invoiceNumber}}. De factuur is als PDF bijgevoegd aan dit bericht.",
    ],
    detailRows: [
      { label: "Factuurnummer", value: "{{invoiceNumber}}" },
      { label: "Totaalbedrag", value: "{{totalAmount}}" },
      { label: "Vervaldatum", value: "{{dueDate}}" },
    ],
    cta: { label: "Factuur online betalen", href: "{{paymentUrl}}", optionalVariable: "paymentUrl" },
    secondaryLink: { label: "Factuur bekijken in uw klantportaal", href: "{{invoiceUrl}}" },
    footerNote: "Neem bij vragen contact op met ons.",
  ...
  invoice_payment_reminder: {
    ...
    preheader: "Wij hebben nog geen betaling ontvangen voor factuur {{invoiceNumber}}.",
    headline: "Betalingsherinnering",
    intro: [
      "Beste {{customerName}},",
    ...
    footerNote: "Heeft u al betaald? Dan kunt u dit bericht als niet verzonden beschouwen. Neem bij vragen contact op met ons.",
    requiredVariables: ["customerName", "invoiceNumber", "totalAmount", "dueDate", "invoiceUrl"],
  ...
  notification_test: {
    ...
    category: "notifications",
    subject: "Test: {{notificationTypeLabel}}",
    preheader: "Testmelding voor {{notificationTypeLabel}}.",
    headline: "Testmelding: {{notificationTypeLabel}}",
    intro: [
      "Dit is een testmelding voor het notificatietype {{notificationTypeLabel}} ({{notificationType}}).",
      "Als u dit bericht ontvangt, werkt de e-mailconfiguratie correct.",
    ],
  ...
  tenant_mail_settings_test: {
    ...
    name: "Tenant mailinstellingen test",
    category: "platform",
    subject: "Test SMTP-instellingen {{brandName}}",
    preheader: "De tenant e-mailconfiguratie kan berichten afleveren.",
    headline: "E-mailtest geslaagd",
    intro: [
      "Deze e-mail is verzonden vanuit de mailinstellingen van {{brandName}}.",
      "Als u dit bericht ontvangt, kan het platform e-mail afleveren met de huidige configuratie.",
    ],
    requiredVariables: [],
    optionalVariables: [],
  },
  platform_email_test: {
    ...
    intro: [
      "Dit is een testmail vanuit de globale platform e-mailconfiguratie.",
