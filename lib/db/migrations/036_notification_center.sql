...
ALTER TABLE organization_settings
  ...
  ADD COLUMN IF NOT EXISTS email_template_footer_text text DEFAULT 'Dit is een automatisch bericht van Veele Services. U ontvangt dit bericht omdat u betrokken bent bij een aanvraag, opdracht, rapportage, factuur of portaalmelding.' NOT NULL,
  ADD COLUMN IF NOT EXISTS email_template_signature text DEFAULT 'Met vriendelijke groet,\nVeele Services' NOT NULL;
