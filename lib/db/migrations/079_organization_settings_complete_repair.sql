...
-- ============================================================================
-- Never edit recorded migration files. This follow-up repairs legacy databases
-- that have migration history for older organization_settings changes but are
-- still missing columns, defaults, or compatible constraints at runtime.
