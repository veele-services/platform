-- Keep personnel-facing interest poll notifications user-centric and encoding-safe.
...
-- Correct old unread/current in-app copies that may have been created before
-- the wording fix was deployed.
UPDATE personnel_notifications
SET
  title = 'Je bent uitgenodigd',
  body = 'Je bent uitgenodigd voor een interessepeiling. Laat weten of je interesse hebt, niet beschikbaar bent of een vraag hebt.',
  source_label = 'Planning'
WHERE title = 'Nieuwe opdracht onder voorbehoud'
  AND body = 'Een medewerker is uitgenodigd voor een interessepeiling.';
