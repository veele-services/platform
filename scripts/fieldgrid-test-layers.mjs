...
export const fieldgridTestLayers = [
  ...
  },
  {
    ...
    ciCommand:
      "pnpm fieldgrid:runtime-safety:setup && pnpm fieldgrid:runtime-safety:fixtures && pnpm fieldgrid:runtime-safety:db && pnpm fieldgrid:test:db-regressions && pnpm fieldgrid:test:credential-recovery-runtime && pnpm fieldgrid:test:smtp-credential-backfill-runtime && pnpm fieldgrid:test:website-runtime && pnpm fieldgrid:test:website-publication-runtime && pnpm fieldgrid:test:website-forms-runtime",
    requiredTestFiles: [
      "tests/security/assignment-personnel-tenant-guard-source.test.mjs",
