  ...
  return [
    {
      ...
      targets: [
        { id: "dashboard", label: "Platform dashboard", path: "/platform" },
        { id: "tenants", label: "Tenants", path: "/platform/tenants" },
        { id: "knowledgebase", label: "Knowledgebase", path: "/platform/knowledgebase" },
        { id: "roadmap", label: "Roadmap", path: "/platform/roadmap" },
        { id: "releases", label: "Releases", path: "/platform/releases" },
        { id: "settings", label: "Instellingen", path: "/platform/settings" },
      ],
    },
    {
      id: "tenant-admin",
      ...
      targets: [
        ...
        { id: "assignments", label: "Opdrachten", path: "/assignments" },
        { id: "customers", label: "Klanten", path: "/customers" },
        { id: "objects", label: "Objecten", path: "/objects" },
        { id: "personnel", label: "Personeel", path: "/personnel" },
