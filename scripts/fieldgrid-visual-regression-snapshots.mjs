...
export const visualRegressionTargetGroups = [
  ...
  },
  {
    ...
    routes: [
      ...
      "/admin/planning",
      "/admin/customers",
      "/admin/customers/40000000-0000-4000-8000-000000000001",
      "/admin/objects",
      "/admin/objects/50000000-0000-4000-8000-000000000001",
      "/admin/assignments",
      "/admin/personnel",
      "/admin/personnel/60000000-0000-4000-8000-000000000001",
      "/admin/documents",
    ],
  },
  {
