...
export const platformAdminReleaseGateItems = [
  ...
  },
  {
    ...
    requiredCommand: "Playwright host-first smoke voor Tenant A/B/Veele plus wrong-host denial.",
  ...
  },
  {
    ...
    requiredCommand: "Suspend/reactivate/archive/retry smoke op demo tenant met rollback.",
