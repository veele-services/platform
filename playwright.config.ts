...
export default defineConfig({
  ...
  reporter: [
    ...
    [
      "json",
      { outputFile: "artifacts/fieldgrid-playwright/playwright-results.json" },
    ],
    [
      "junit",
      { outputFile: "artifacts/fieldgrid-playwright/junit/results.xml" },
    ],
    [
      "html",
      {
        outputFolder: "artifacts/fieldgrid-playwright/playwright-report",
        open: "never",
      },
    ],
  ],
