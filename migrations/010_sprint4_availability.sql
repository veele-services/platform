...
CREATE INDEX IF NOT EXISTS leave_periods_dates_idx     ON leave_periods (start_date, end_date);
...
-- All authenticated users may SELECT (management via service-role for writes).
