    ...
    <form ref={rootRef} className="relative flex gap-2" action="/help">
      <div className="relative min-w-0 flex-1">
        ...
        <input
          ...
          className="h-11 w-full rounded-xl border border-slate-300 bg-white pl-9 pr-3 text-sm outline-none focus:ring-2 focus:ring-cyan-100"
        />
        {open && visibleSuggestions.length > 0 && (
          <div id={listId} role="listbox" className="absolute left-0 right-0 top-12 z-40 overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-xl">
