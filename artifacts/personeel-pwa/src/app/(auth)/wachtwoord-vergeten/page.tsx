...
import { requestPasswordResetCode, verifyPasswordResetCode } from "@/actions/auth";
...
export default function WachtwoordVergetenPage() {
  ...
  function handleSubmit(e: React.FormEvent) {
    ...
    startTransition(async () => {
      ...
      if (!result.success) {
        setError(result.message ?? "Er is een fout opgetreden. Controleer je e-mailadres en probeer het opnieuw.");
        return;
      }
        ...
        <div className="w-full max-w-sm">
          <div className="mb-10 text-center">
            ...
            <p className="mt-1 text-sm" style={{ color: "#94A3B8" }}>
              Vul je e-mailadres in voor een herstelcode
            </p>
          </div>
          ...
          <div className="rounded-2xl bg-white p-6 shadow-lg">
            {sent ? (
              <form onSubmit={handleVerifyCode} className="space-y-4" noValidate>
                ...
                >
                  Controleer je inbox. Vul de herstelcode hieronder in om een nieuw wachtwoord te kiezen.
                </div>
