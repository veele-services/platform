...
export default function PersonnelOnboardingPrivacyPage() {
  return (
    <main className="min-h-dvh bg-slate-50 px-4 py-8">
      <article className="mx-auto max-w-2xl rounded-2xl border border-slate-200 bg-white p-5 shadow-sm sm:p-7">
        ...
        <div className="mt-4 space-y-4 text-sm leading-6 text-slate-700">
          <p>
            Tijdens de onboarding slaan we alleen profiel-, bereikbaarheids-,
            werk- en beschikbaarheidsgegevens op die nodig zijn voor uw
            werkzaamheden.
          </p>
          <p>
            Conceptgegevens zijn alleen beschikbaar voor bevoegde
            serverprocessen binnen uw organisatie. Na afronding worden de
            gecontroleerde gegevens in uw personeelsprofiel verwerkt.
          </p>
          <p>
            U kunt veel gegevens later in het personeelsportaal bekijken en
