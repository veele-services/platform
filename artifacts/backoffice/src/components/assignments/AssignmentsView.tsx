            ...
            >
              <div className="grid gap-4">
                ...
                <Select
                  ...
                  onValueChange={(v) =>
                    applyFilter("reportStatus", v === "all" ? "" : v)
                  }
                >
            ...
            >
              ...
              <div className="mt-3 flex flex-wrap items-center gap-2 text-xs text-muted-foreground">
                ...
                {row.personnelCount > 0 && (
                  <span>{row.personnelCount} medewerkers</span>
                )}
              </div>
            </article>
          ))}
                ...
                rows.map((row, i) => (
                  ...
                  >
                    <td className="px-4 py-3">
                      <span
                        className="inline-block font-mono text-xs rounded px-1.5 py-0.5 bg-slate-100"
                        style={{ color: "#475569" }}
                      >
                        {row.code}
                      </span>
