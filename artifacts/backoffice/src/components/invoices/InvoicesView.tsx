...
export function InvoicesView({
  ...
  async function handleSendReminders() {
    ...
    if (result.success && "data" in result && result.data) {
      ...
      if (skippedNoEmail > 0)
        parts.push(`${skippedNoEmail} overgeslagen zonder e-mailadres`);
  ...
  async function handleCreatePaymentLink(invoiceId: string) {
    ...
    toast.error(
      "message" in result ? result.message : "Betaallink aanmaken mislukt",
    );
  }
            ...
            <AlertDialog>
              ...
              <AlertDialogContent>
                <AlertDialogHeader>
                  ...
                  <AlertDialogDescription>
                    Er {overdueCount === 1 ? "is" : "zijn"} {overdueCount}{" "}
                    achterstallige factuur{overdueCount !== 1 ? "en" : ""}.
                    Klanten met een e-mailadres ontvangen een
      ...
      <TenantCommandBar
        ...
        activeFilters={
          <TenantActiveFilters
            ...
            clearAll={
              activeFilterCount > 0 ? (
                <Link href="/invoices">Filters wissen</Link>
              ) : undefined
            }
          />
        }
      ...
      {totalPages > 1 && (
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          <p className="text-xs text-muted-foreground">
            {total} factuur{total !== 1 ? "en" : ""} - pagina {page} van{" "}
            {totalPages}
          </p>
    ...
    <TenantActionMenu
      actions={[
        ...
        },
        {
          id: "pdf",
          label: "Download PDF",
          href: `/backoffice-api/invoices/${row.id}/pdf`,
