...
const SETTINGS_TABS = [
  ...
  { href: "/instellingen/facturen", label: "Facturen", icon: ReceiptText, permission: "settings:write" },
  ...
  { href: "/settings/checklists", label: "Quality & Checklists", icon: ClipboardCheck, permission: "checklists:read" },
