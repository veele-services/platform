...
export function KnowledgebaseContentRenderer({
  ...
  return (
    <div
      className={cn(
        "kb-rendered-content max-w-none text-sm leading-7 text-slate-700",
        "[&_a]:font-semibold [&_a]:text-cyan-700 [&_a]:underline",
        "[&_h2]:mb-2 [&_h2]:mt-6 [&_h2]:text-xl [&_h2]:font-semibold [&_h2]:text-slate-950",
        "[&_h3]:mb-2 [&_h3]:mt-5 [&_h3]:text-base [&_h3]:font-semibold [&_h3]:text-slate-950",
        "[&_li]:my-1 [&_ol]:ml-5 [&_ol]:list-decimal [&_p]:my-3 [&_ul]:ml-5 [&_ul]:list-disc",
        "[&_table]:my-5 [&_table]:w-full [&_table]:border-collapse [&_table]:overflow-hidden [&_table]:rounded-lg [&_table]:text-left",
        "[&_td]:border [&_td]:border-slate-200 [&_td]:p-3 [&_td]:align-top",
        "[&_th]:border [&_th]:border-slate-200 [&_th]:bg-slate-50 [&_th]:p-3 [&_th]:align-top [&_th]:font-semibold [&_th]:text-slate-950",
        "[&_figure]:my-5 [&_figcaption]:mt-2 [&_figcaption]:text-xs [&_figcaption]:text-slate-500",
        "[&_img]:max-h-[520px] [&_img]:w-auto [&_img]:max-w-full [&_img]:rounded-lg [&_img]:border [&_img]:border-slate-200",
        "[&_video]:max-h-[520px] [&_video]:w-full [&_video]:rounded-lg [&_video]:border [&_video]:border-slate-200",
        "[&_iframe]:aspect-video [&_iframe]:w-full [&_iframe]:rounded-lg [&_iframe]:border [&_iframe]:border-slate-200",
        "[&_[data-type='callout']]:my-4 [&_[data-type='callout']]:rounded-lg [&_[data-type='callout']]:border [&_[data-type='callout']]:p-4",
