...
const assignment: ProcessStatusConfig[] = [
  ...
  { value: "in_progress", label: "In uitvoering", description: "Werkzaamheden zijn gestart.", tone: "review", order: 90 },
  { value: "not_completed", label: "Afgemeld / niet afgerond", shortLabel: "Afgemeld", description: "Werkbon is niet volledig afgerond.", tone: "danger", order: 100 },
  { value: "completed", label: "Afgerond", description: "Werkbon is afgerond door personeel.", tone: "success", order: 110 },
  { value: "report_submitted", label: "Rapport ter controle", shortLabel: "Rapport controle", description: "Rapport wacht op backofficecontrole.", tone: "warning", order: 120 },
  { value: "report_approved", label: "Rapport goedgekeurd", description: "Rapport is goedgekeurd.", tone: "success", order: 130 },
  { value: "invoice_ready", label: "Factureerbaar", description: "Opdracht is klaar voor facturatie.", tone: "warning", order: 140 },
  { value: "invoiced", label: "Gefactureerd", description: "Factuur is aangemaakt/verzonden.", tone: "info", order: 150 },
  { value: "paid", label: "Betaald", description: "Betaling is ontvangen.", tone: "success", order: 160 },
  { value: "closed", label: "Afgehandeld", description: "Workflow is volledig afgesloten.", tone: "closed", order: 170 },
];
