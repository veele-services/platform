      ...
      <div className="mx-auto grid w-full max-w-[1000px] gap-6">
        <header className="border-b border-slate-200 pb-6">
          ...
          <p className="mt-2 max-w-3xl text-sm leading-6 text-slate-600">
            Beschrijf wat u mist, waarom het belangrijk is en welk proces
            hiermee beter wordt.
          </p>
        </header>
            ...
            <div className="grid gap-4 md:grid-cols-[220px_minmax(0,1fr)]">
              ...
              <label className="grid gap-1 text-sm font-medium text-slate-700">
                ...
                <SelectAdapter
                  name="moduleKeys"
                  multiple
                  className="min-h-32 rounded-md border border-slate-300 bg-white px-3 py-2 text-sm font-normal"
                >
                ...
                <span className="text-xs font-normal text-slate-500">
                  Gebruik Ctrl/Cmd om meerdere modules te selecteren.
                </span>
              </label>
            </div>
