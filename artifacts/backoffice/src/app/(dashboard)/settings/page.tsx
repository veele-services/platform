...
import { Bell, Building2, Shield, Users, ClipboardList, ClipboardCheck, ChevronRight, History, Tag, Layers3, Mail, SlidersHorizontal, Sparkles, ReceiptText } from "lucide-react";
...
export default async function SettingsPage() {
  ...
  const [canWriteSettings, canReadRoles, canReadUsers, canReadSettings, canReadPlanning, canReadChecklists] = await Promise.all([
    hasPermission("settings", "write"),
    hasPermission("roles",    "read"),
    hasPermission("users",    "read"),
    hasPermission("settings", "read"),
    hasPermission("planning", "read"),
    hasPermission("checklists", "read"),
  ]);
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        {canWriteSettings && (
          <SettingsCard
            ...
            icon={<Building2 className="h-6 w-6" style={{ color: "var(--color-primary)" }} strokeWidth={1.5} />}
            title="Organisatie"
        ...
        {canWriteSettings && (
          <SettingsCard
            ...
            icon={<Mail className="h-6 w-6" style={{ color: "var(--color-primary)" }} strokeWidth={1.5} />}
            title="Mail"
        ...
        {canWriteSettings && (
          <SettingsCard
            ...
            icon={<ReceiptText className="h-6 w-6" style={{ color: "var(--color-primary)" }} strokeWidth={1.5} />}
            title="Facturen"
        ...
        {canWriteSettings && (
          <SettingsCard
            ...
            icon={<Bell className="h-6 w-6" style={{ color: "var(--color-primary)" }} strokeWidth={1.5} />}
            title="Notificaties"
        ...
        {canWriteSettings && (
          <SettingsCard
            ...
            icon={<Sparkles className="h-6 w-6" style={{ color: "var(--color-primary)" }} strokeWidth={1.5} />}
        ...
        {canReadRoles && (
          <SettingsCard
            ...
            icon={<Shield className="h-6 w-6" style={{ color: "var(--color-primary)" }} strokeWidth={1.5} />}
        ...
        {canReadUsers && (
          <SettingsCard
            ...
            icon={<Users className="h-6 w-6" style={{ color: "var(--color-primary)" }} strokeWidth={1.5} />}
            title="Gebruikers"
        ...
        <SettingsCard
          ...
          icon={<ClipboardList className="h-6 w-6" style={{ color: "var(--color-primary)" }} strokeWidth={1.5} />}
          title="Taakcodes"
        ...
        {canReadChecklists && (
          <SettingsCard
            ...
            icon={<ClipboardCheck className="h-6 w-6" style={{ color: "var(--color-primary)" }} strokeWidth={1.5} />}
            title="Quality & Checklists"
            description="Beheer versievaste templates, contextuele koppelingen, previews en reconciliatiebesluiten."
          />
        )}
        {canReadSettings && (
          <SettingsCard
            href="/instellingen/sectoren"
            icon={<Layers3 className="h-6 w-6" style={{ color: "var(--color-primary)" }} strokeWidth={1.5} />}
            title="Sectoren"
        ...
        {canReadPlanning && (
          <SettingsCard
            ...
            icon={<SlidersHorizontal className="h-6 w-6" style={{ color: "var(--color-primary)" }} strokeWidth={1.5} />}
            title="Slim plannen"
        ...
        {canReadSettings && (
          <SettingsCard
            ...
            icon={<Tag className="h-6 w-6" style={{ color: "var(--color-primary)" }} strokeWidth={1.5} />}
            title="Klanttypes"
        ...
        {canReadSettings && (
          <SettingsCard
            ...
            icon={<History className="h-6 w-6" style={{ color: "var(--color-primary)" }} strokeWidth={1.5} />}
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        <p className="text-sm font-semibold group-hover:underline" style={{ color: "var(--color-foreground)" }}>
          {title}
        </p>
