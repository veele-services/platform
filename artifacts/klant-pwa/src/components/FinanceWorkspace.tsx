...
const toneStyles: Record<FinanceTone, { bg: string; color: string; border: string }> = {
  neutral: {
    bg: "var(--color-muted)",
...
export function FinanceSummaryStrip({ items }: { items: FinanceSummaryItem[] }) {
  return (
    <section
      className="grid gap-3 rounded-2xl border bg-white p-3 shadow-sm sm:grid-cols-2 xl:grid-cols-4"
  ...
  return (
    ...
    >
      <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
        <div className="min-w-0">
          <p className="text-[11px] font-black uppercase" style={{ color: style.color }}>
            {eyebrow}
          </p>
