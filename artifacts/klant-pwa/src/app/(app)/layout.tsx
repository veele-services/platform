  ...
  return (
    <div className="flex min-h-screen" style={{ backgroundColor: "#F4F7FB" }}>
      ...
      <div className="flex min-w-0 flex-1 flex-col">
        ...
        <header className="sticky top-0 z-30 hidden border-b bg-white/92 px-7 py-4 backdrop-blur md:flex md:items-center md:justify-end" style={{ borderColor: "var(--color-border)" }}>
          <div className="flex items-center gap-3">
            <div className="rounded-full border px-4 py-2 text-sm font-black" style={{ borderColor: "var(--color-border)", color: "var(--color-primary)" }}>
