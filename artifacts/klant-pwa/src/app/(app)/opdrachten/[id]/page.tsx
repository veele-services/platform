...
export default async function KlantWerkbonDetailPage({ params }: Props) {
  ...
  return (
    ...
    >
      ...
      <div className="mx-auto max-w-[1280px] space-y-4 p-4 md:grid md:grid-cols-[1fr_22rem] md:items-start md:gap-5 md:p-7 md:space-y-0">
        <div
          className="hidden rounded-[22px] border bg-white px-6 py-5 shadow-sm md:col-span-2 md:flex md:items-center md:justify-between md:gap-5"
        ...
        <div
          ...
          style={{
            backgroundColor: (
              STATUS_COLOR[assignment.status] ?? STATUS_COLOR.requested
            ).bg,
          }}
        >
          <p
            ...
            style={{
              color: (STATUS_COLOR[assignment.status] ?? STATUS_COLOR.requested)
                .color,
            }}
          >
            Status:{" "}
                ...
                >
                  <div className="flex items-center justify-between gap-2 mb-2">
                    ...
                    <span
                      ...
                      style={{
                        backgroundColor:
                          INVOICE_STATUS_COLOR[invoice.status].bg,
