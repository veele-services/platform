        ...
        items={[
          {
            ...
            description: `${openInvoices.length} ${openInvoices.length === 1 ? "factuur" : "facturen"} klaar voor betaling.`,
            icon: <Clock size={18} />,
          ...
          },
          {
            ...
            description: `${overdueInvoices.length} ${overdueInvoices.length === 1 ? "factuur" : "facturen"} over de vervaldatum.`,
          ...
          },
          {
            ...
            description: `${dueSoonInvoices.length} ${dueSoonInvoices.length === 1 ? "factuur" : "facturen"} vervalt binnen 14 dagen.`,
          ...
          },
          {
            ...
            description: `${paidInvoices.length} ${paidInvoices.length === 1 ? "factuur" : "facturen"} afgerond.`,
