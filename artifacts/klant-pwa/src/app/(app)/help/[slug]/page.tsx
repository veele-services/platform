          ...
          <section className="rounded-2xl border bg-white p-5 shadow-sm" style={{ borderColor: "var(--color-border)" }}>
            ...
            <div className="mt-3 grid gap-2">
              {article.media.map((item) => (
                <a key={item.id} href={item.publicUrl ?? "#"} target="_blank" rel="noreferrer" className="flex items-center gap-3 rounded-xl border p-3 text-sm" style={{ borderColor: "var(--color-border)" }}>
