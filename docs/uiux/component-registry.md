...
| Combobox      | `artifacts/backoffice/src/components/ui/combobox.tsx`                                 | Popover/Command| searchable bounded single choice                              | state, width         | canonical |
| Table         | `artifacts/backoffice/src/components/ui/table.tsx`                                    | semantic table | desktop data view                                             | density              | canonical |
| Data view     | `artifacts/backoffice/src/components/ui/fieldgrid-data-view.tsx`                      | mixed          | responsive server-backed lists with sorting and selection     | density, columns     | canonical |
...
| Form section  | `artifacts/backoffice/src/components/ui/form-section.tsx`                             | n/a            | programmatically named responsive form group                  | actions              | canonical |
