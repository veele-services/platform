...
Iedere gevorderde acceptance-, risico- of baselineclaim faalt zonder exact de beschermde root, de toegestane base→kandidaat-lifecycleovergang en het vereiste tweefasenbewijs. Rootrotatie gebeurt in een aparte contractwijziging onder de gewone repository-branch-protection; het rootprotocol legt geen extra revieweraantal, reviewerrol of reviewbodymarker op en de wijzigende PR registreert zijn eigen root nooit zelf.
